...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/freelancers-user-list-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:12:58 GMT -->
<head>
<meta charset="utf-8">
...
<div id="wrapper"> 
                ...
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="#"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
				      ...
				      <li class="active"><a href="freelancers-user-list-layout.html"><i class="icon-feather-chevron-right"></i> Freelancer User List</a></li>
  ...
  <div id="titlebar" class="gradient">
	<div class="container">
	  <div class="row">
		<div class="col-md-12">
		  <h2>Freelancer List With Left Sidebar</h2>
		  <nav id="breadcrumbs">
			<ul>
			  <li><a href="index-1.html">Home</a></li>
			  <li>Freelancer List With Left Sidebar</li>
			</ul>
		  </nav>
		</div>
	  </div>
      ...
      <div class="col-xl-3 col-lg-4">
        <div class="utf-sidebar-container-aera">
		  ...
		  <div class="utf-sidebar-widget-item">
            ...
            <input class="range-slider" type="text" value="" data-slider-currency="$" data-slider-min="10" data-slider-max="500" data-slider-step="10" data-slider-value="[10,500]"/>
          </div>
      ...
      <div class="col-xl-9 col-lg-8 content-left-offset">
        ...
        <div class="freelancers-container freelancers-list-layout margin-top-35"> 
          <div class="freelancer"> 
            <div class="utf-manage-resume-overview-aera">
              <div class="utf-manage-resume-overview-aera-inner"> 
                <span class="bookmark-icon"></span> 
                <div class="utf-manage-resume-avatar">
                  <div class="utf-verified-badge" title="Verified Employer" data-tippy-placement="top"></div>
                  <a href="single-freelancer-profile.html"><img src="images/user-avatar-placeholder.png" alt=""></a> 
				</div>
                <div class="utf-manage-resume-item">
				  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> Afghanistan</a></span>
                  <h4><a href="single-freelancer-profile.html">John Williams <span>Web Designer</span></a></h4>
            ...
            <div class="freelancer-details">
              <div class="freelancer-details-list">
                <ul>
                  <li><i class="icon-material-outline-account-balance-wallet"></i> Hourly Rate <strong>$35 / Hr</strong></li>
                  <li><i class="icon-feather-briefcase"></i> Job Success <strong>100%</strong></li>
                </ul>
              </div>
              <a href="single-freelancer-profile.html" class="button">Freelancer User Profile</a> 
			</div>
          </div>
          <!-- Freelancer / End --> 
          ...
          <div class="freelancer"> 
            <div class="utf-manage-resume-overview-aera">
              <div class="utf-manage-resume-overview-aera-inner"> 
                ...
                <div class="utf-manage-resume-item">
				  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> Afghanistan</a></span>
                  <h4><a href="single-freelancer-profile.html">John Williams <span>iOS Developer</span></a></h4>
                  <div class="freelancer-rating">
                    <div class="utf-star-rating" data-rating="4.5"></div>
                  </div>
                </div>
          ...
          <div class="freelancer"> 
            <div class="utf-manage-resume-overview-aera">
              <div class="utf-manage-resume-overview-aera-inner"> 
                ...
                <div class="utf-manage-resume-item">
				  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> Afghanistan</a></span>
                  <h4><a href="single-freelancer-profile.html">John Williams <span>Front-End Developer</span></a></h4>
                  <span class="utf-company-not-rated margin-bottom-5">Minimum of 3 votes required</span>
                </div>
              </div>
            </div>            
            <div class="freelancer-details">
          ...
          <div class="freelancer"> 
            <div class="utf-manage-resume-overview-aera">
              <div class="utf-manage-resume-overview-aera-inner"> 
                ...
                <div class="utf-manage-resume-item">
				  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> Afghanistan</a></span>
                  <h4><a href="single-freelancer-profile.html">John Williams <span>Wordpress Developer</span></a></h4>
                  <div class="freelancer-rating">
                    <div class="utf-star-rating" data-rating="4.5"></div>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-12"> 
            <!-- Pagination -->
            <div class="utf-pagination-container-aera margin-top-20 margin-bottom-60">
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/freelancers-user-list-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:00 GMT -->
</html>