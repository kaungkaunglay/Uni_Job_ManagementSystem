...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/jobs-listing-with-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:10:41 GMT -->
<head>
<meta charset="utf-8">
...
<div id="wrapper"> 
  <!-- Header Container -->
  <header id="utf-header-container-block" class="fullwidth"> 
    <div id="header">
      <div class="container"> 
          ...
          <nav id="navigation">
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Find Jobs</a>
                <ul class="dropdown-nav">
                  <li class="active"><a href="#"><i class="icon-feather-chevron-right"></i> Browse Jobs</a>
                    <ul class="dropdown-nav">
					  ...
					  <li class="active"><a href="jobs-listing-with-map.html"><i class="icon-feather-chevron-right"></i> Jobs List With Map</a></li>
                    </ul>
                  </li>
  ...
  <div class="full-page-container with-map">
    ...
    <div class="full-page-content-container" data-simplebar>
      <div class="full-page-content-inner">
        ...
        <div class="utf-listings-container-part compact-list-layout margin-top-35 margin-bottom-25">           
			<a href="single-job-page.html" class="utf-job-listing"> 
			  <div class="utf-job-listing-details"> 
				...
				<div class="utf-job-listing-description">
				  ...
				  <h3 class="utf-job-listing-title">Web Designer, Graphic Designer, UI/UX Designer <span class="utf-verified-badge" title="Verified Employer" data-tippy-placement="top"></span></h3>
				  <div class="utf-job-listing-footer">
					<ul>
					  ...
					  <li><i class="icon-material-outline-location-on"></i> Drive Potsdam</li>
        ...
        <div class="utf-small-footer margin-top-15">
          <div class="utf-small-footer-copyrights">Copyright © 2021 All Rights Reserved.</div>
          <div class="clearfix"></div>
        </div>
        <!-- Footer / End --> 
      </div>
    ...
    <div class="full-page-map-container"> 
      <div class="filter-button-container">
        <button class="enable-filters-button"> <span class="show-text">Show More Filter</span> <span class="hide-text">Less More Filter</span> </button>
      </div>
      <div id="map" data-map-zoom="2" data-map-scroll="true"></div>
    </div>
    <!-- Full Page Map / End --> 
  </div>
</div>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/jobs-listing-with-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:10:45 GMT -->
</html>