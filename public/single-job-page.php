...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/single-job-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:10:45 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Find Jobs</a>
                <ul class="dropdown-nav">
                  ...
                  <li class="active"><a href="single-job-page.html"><i class="icon-feather-chevron-right"></i> Jobs Detail Page</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="utf-single-page-header-inner-aera">
            <div class="utf-left-side">
              <div class="utf-header-image"><a href="single-company-profile.html"><img src="images/company_logo_1.png" alt=""></a></div>
              <div class="utf-header-details">
                ...
                <h3>Business Manager <span class="utf-verified-badge" title="Verified" data-tippy-placement="top"></span></h3>
  ...
  <div class="container">
    <div class="row"> 
      <div class="col-xl-8 col-lg-8 utf-content-right-offset-aera">
		...
		<div class="utf-single-page-section-aera">
		  <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-briefcase"></i> Education Qualification</h3>
          </div>
          <p>Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has been the industry's standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>          
		...
		<div class="utf-single-page-section-aera">
          ...
          <ul class="utf-job-deatails-content-item">
			<li><i class="icon-feather-arrow-right"></i> Commitment – understanding the price and having the willingness to pay that price</li>
			<li><i class="icon-feather-arrow-right"></i> Taking action – practice Ready, Fire, Aim…</li>
			<li><i class="icon-feather-arrow-right"></i> You will drift aimlessly until you arrive back at the original dock.</li>
			<li><i class="icon-feather-arrow-right"></i> You will run aground and become hopelessly stuck in the mud.</li>
			<li><i class="icon-feather-arrow-right"></i> Belief – believing in yourself and those around you.</li>			
		  </ul>		  
        </div>
		
		<div class="utf-single-page-section-aera">
		  <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-material-outline-business-center"></i> Primary Responsibilities</h3>
          </div>
          <ul class="utf-job-deatails-content-item">
			<li><i class="icon-feather-arrow-right"></i> HTML, CSS & Scss</li>
			<li><i class="icon-feather-arrow-right"></i> Javascript</li>
			<li><i class="icon-feather-arrow-right"></i> PHP Developer</li>
			<li><i class="icon-feather-arrow-right"></i> Photoshop</li>
			<li><i class="icon-feather-arrow-right"></i> Illustrator</li>			
		  </ul>		  
        </div>
		...
		<div class="utf-boxed-list-item margin-bottom-60">
		  ...
		  <div class="utf-centered-button margin-top-10"> <a href="jobs-list-layout-leftside.html" class="button utf-button-sliding-icon">View More Jobs <i class="icon-feather-chevron-right"></i></a> </div>
        </div>		
      </div>
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs"> 
  <div class="utf-signin-form-part">
    <ul class="utf-popup-tabs-nav-item">
		<li class="modal-title">Apply for This Job</li>
	</ul>
      ...
      <div class="utf-popup-tab-content-item" id="tab"> 
        <form method="post" id="apply-now-form">
          <div class="utf-no-border margin-bottom-18">
			<select class="selectpicker utf-with-border" data-size="5" title="Select Location">
          ...
          <div class="uploadButton">
            ...
            <label class="uploadButton-button ripple-effect" for="upload-cv">Upload Resume</label>
            <span class="uploadButton-file-name">Upload Resume (Docx, Doc, PDF) File.</span> 
		  </div>
        </form>
        <button class="button margin-top-25 full-width utf-button-sliding-icon ripple-effect" type="submit" form="apply-now-form">Apply Now <i class="icon-feather-chevron-right"></i></button>
		<p class="margin-top-15">You can apply to this job and others using your online resume. Click the link below to submit your online resume and email your application to this employer.</p>
		<a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-10">Submit Resume & Apply <i class="icon-feather-chevron-right"></i></a>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="utf-popup-container-part-tabs"> 
      ...
      <div class="utf-popup-tab-content-item" id="login"> 
        ...
        <form method="post" id="login-form">
          <div class="utf-no-border">
            <input type="text" class="utf-with-border" placeholder="Email Address" required/>
          </div>
          <div class="utf-no-border">
      ...
      <div class="utf-popup-tab-content-item" id="register"> 
        ...
        <form method="post" id="utf-register-account-form">
          <div class="utf-no-border">
            <input type="text" class="utf-with-border" name="username" id="username" placeholder="User Name" required/>
          </div>
		  <div class="utf-no-border">
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/single-job-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:10:49 GMT -->
</html>