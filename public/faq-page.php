...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/faq-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:29 GMT -->
<head>
<meta charset="utf-8">
...
<div id="wrapper"> 
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Pages</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="faq-page.html"><i class="icon-feather-chevron-right"></i> FAQ Page</a></li>		
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-12">
        <div class="accordion js-accordion margin-bottom-70"> 
