...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-freelancer-manage-tasks-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:24 GMT -->
<head>
<meta charset="utf-8">
              ...
              <li><a href="#" class="current">User Panel</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="dashboard-manage-tasks.html"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
                      <li class="active"><a href="dashboard-freelancer-manage-tasks-list.html"><i class="icon-feather-chevron-right"></i> Freelancer Manage Tasks</a></li>
  ...
  <div class="utf-dashboard-container-aera"> 
    ...
    <div class="utf-dashboard-content-container-aera" data-simplebar>
	  <div id="dashboard-titlebar" class="utf-dashboard-headline-item">
		<div class="row">
			<div class="col-xl-12">	
				<h3>Freelancer Manage Tasks List</h3>
				<nav id="breadcrumbs">
					<ul>
					  <li><a href="index-1.html">Home</a></li>
					  <li>Freelancer Manage Tasks List</li>
					</ul>
				</nav>
			</div>
		</div>		
        ...
        <div class="row"> 
          <div class="col-xl-12">
            <div class="dashboard-box margin-top-0"> 
              <div class="headline">
                <h3>Freelancer Bidder Tasks List</h3>
              </div>
              <div class="content">
                <ul class="utf-dashboard-box-list">
                  <li> 
                    <div class="utf-job-listing width-adjustment"> 
                      <div class="utf-job-listing-details"> 
                        <div class="utf-job-listing-description">
                          <h3 class="utf-job-listing-title"><a href="dashboard-manage-bidders-list.html">Web Designer and Web Developer</a></h3>
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>15</strong><span>Total Bids</span></li>
                      <li><strong>$50</strong><span>Average Bids</span></li>
                      <li><strong>$25 - $45</strong><span>Hourly Price</span></li>
                    </ul>
                  ...
                  <li> 
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>32</strong><span>Total Bids</span></li>
                      <li><strong>$50</strong><span>Average Bids</span></li>
                      <li><strong>$25 - $45</strong><span>Hourly Price</span></li>
                    </ul>
                    <div class="utf-buttons-to-right"> 
				  ...
				  <li> 
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>25</strong><span>Total Bids</span></li>
                      <li><strong>$50</strong><span>Average Bids</span></li>
                      <li><strong>$8,000 - $12,000</strong><span>Fixed Price</span></li>
                    </ul>
                    <div class="utf-buttons-to-right"> 
						<a href="#" class="button green ripple-effect ico" title="Edit" data-tippy-placement="top"><i class="icon-feather-edit"></i></a>
						<a href="#" class="button red ripple-effect ico" title="Remove" data-tippy-placement="top"><i class="icon-feather-trash-2"></i></a> 
				  ...
				  <li> 
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>18</strong><span>Total Bids</span></li>
                      <li><strong>$50</strong><span>Average Bids</span></li>
                      <li><strong>$25 - $45</strong><span>Hourly Price</span></li>
                    </ul>
                    <div class="utf-buttons-to-right"> 
				  ...
				  <li> 
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>44</strong><span>Total Bids</span></li>
                      <li><strong>$50</strong><span>Average Bids</span></li>
                      <li><strong>$25 - $45</strong><span>Hourly Price</span></li>
                    </ul>
                    <div class="utf-buttons-to-right"> 
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs"> 
  <div class="utf-signin-form-part">
    <ul class="utf-popup-tabs-nav-item">
		<li class="modal-title">Freelancer Edit Bid</li>
	</ul>
    <div class="utf-popup-container-part-tabs"> 
      <div class="utf-popup-tab-content-item" id="tab"> 
        <div class="bidding-widget"> 
          ...
          <div class="bidding-fields">
            <div class="bidding-field"> 
              <div class="qtyButtons utf-with-border">
            ...
            <div class="bidding-field">
              <select class="selectpicker default utf-with-border">
        ...
        <button class="button full-width utf-button-sliding-icon ripple-effect" type="submit">Save Changes <i class="icon-material-outline-arrow-right-alt"></i></button>
      </div>
    </div>
  </div>
</div>
