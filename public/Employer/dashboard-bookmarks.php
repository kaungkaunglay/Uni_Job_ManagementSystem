...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-bookmarks.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:24 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">User Panel</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="dashboard-bookmarks.html"><i class="icon-feather-chevron-right"></i> Bookmarks Jobs</a></li>
          ...
          <div class="utf-dashboard-nav">
            <div class="utf-dashboard-nav-inner">
              ...
              <ul>
				...
				<li class="active"><a href="dashboard-bookmarks.html"><i class="icon-feather-heart"></i> Bookmarks Jobs</a></li>
              ...
              <div class="content">
                <ul class="utf-dashboard-box-list">
                  <li> 
                    <div class="utf-job-listing"> 
                      <div class="utf-job-listing-details"> 
                        <a href="#" class="utf-job-listing-company-logo"> <img src="images/company_logo_1.png" alt=""> </a> 
                        <div class="utf-job-listing-description">
                          ...
                          <h3 class="utf-job-listing-title"><a href="#">Web Designer, Graphic Designer and UI/UX Designer</a></h3>
                  ...
                  <li> 
                    <div class="utf-job-listing"> 
                      <div class="utf-job-listing-details"> 
                        <a href="#" class="utf-job-listing-company-logo"> <img src="images/company_logo_2.png" alt=""> </a> 
                        <div class="utf-job-listing-description">
                          ...
                          <h3 class="utf-job-listing-title"><a href="#">PHP Developer, Team of PHP & IT</a></h3>
                          <div class="utf-job-listing-footer">
                            <ul>
							  <li><i class="icon-feather-briefcase"></i> Software Developer</li>							
                              <li><i class="icon-material-outline-location-on"></i> 2767 Concord Street, Charlotte</li>
                  ...
                  <li> 
                    <div class="utf-job-listing"> 
                      <div class="utf-job-listing-details"> 
                        <a href="#" class="utf-job-listing-company-logo"> <img src="images/company_logo_3.png" alt=""> </a> 
                        <div class="utf-job-listing-description">
						  <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                          <h3 class="utf-job-listing-title"><a href="#">Application Developer & Web Designer</a></h3>
                          <div class="utf-job-listing-footer">
                            <ul>
							  <li><i class="icon-feather-briefcase"></i> Software Developer</li>							
                              <li><i class="icon-material-outline-location-on"></i> 2767 Concord Street, Charlotte</li>
				  ...
				  <li> 
                    <div class="utf-job-listing"> 
                      <div class="utf-job-listing-details"> 
                        <a href="#" class="utf-job-listing-company-logo"> <img src="images/company_logo_4.png" alt=""> </a> 
                        <div class="utf-job-listing-description">
						  <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                          <h3 class="utf-job-listing-title"><a href="#">Head of Developers & MySQL Developers</a></h3>
                          <div class="utf-job-listing-footer">
                            <ul>
							  <li><i class="icon-feather-briefcase"></i> Software Developer</li>							
                              <li><i class="icon-material-outline-location-on"></i> 2767 Concord Street, Charlotte</li>
                  ...
                  <li> 
                    <div class="utf-job-listing"> 
                      <div class="utf-job-listing-details"> 
                        <a href="#" class="utf-job-listing-company-logo"> <img src="images/company_logo_5.png" alt=""> </a> 
                        <div class="utf-job-listing-description">
						  <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                          <h3 class="utf-job-listing-title"><a href="#">Website Developer & Software Developer</a></h3>
                          <div class="utf-job-listing-footer">
                            <ul>
							  <li><i class="icon-feather-briefcase"></i> Software Developer</li>	
                              <li><i class="icon-material-outline-location-on"></i> 2767 Concord Street, Charlotte</li>
                              <li><i class="icon-material-outline-account-balance-wallet"></i> $35000-$38000</li>
                              <li><i class="icon-material-outline-access-time"></i> 4 Days Ago</li>
                            </ul>
                          </div>
                        </div>
                      </div>
