...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-manage-resume.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:13 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">User Panel</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="dashboard-manage-resume.html"><i class="icon-feather-chevron-right"></i> Manage Resume</a></li>  
          ...
          <div class="utf-dashboard-nav">
            <div class="utf-dashboard-nav-inner">
              ...
              <ul>
				...
				<li class="active"><a href="dashboard-manage-resume.html"><i class="icon-material-outline-supervisor-account"></i> Manage Resume</a></li>
				<li><a href="dashboard-bookmarks.html"><i class="icon-feather-heart"></i> Bookmarks Jobs</a></li>
                    ...
                    <div class="utf-manage-resume-overview-aera utf-manage-candidate">
                      <div class="utf-manage-resume-overview-aera-inner"> 
                        ...
                        <div class="utf-manage-resume-item">
                          <h4><a href="#">John Williams</a><span class="dashboard-status-button green"><i class="icon-material-outline-business-center"></i> Full Time</span></h4>
                          ...
                          <div class="utf-buttons-to-right"> 
							<a href="#small-dialog" class="popup-with-zoom-anim button ripple-effect" title="Send Message" data-tippy-placement="top"><i class="icon-feather-mail"></i> Send</a>
							<a href="#" class="button green ripple-effect ico" title="Download CV" data-tippy-placement="top"><i class="icon-feather-download"></i></a>
				  ...
				  <li> 
                    <div class="utf-manage-resume-overview-aera utf-manage-candidate">
                      <div class="utf-manage-resume-overview-aera-inner"> 
                        ...
                        <div class="utf-manage-resume-item">
                          <h4><a href="#">John Williams</a><span class="dashboard-status-button yellow"><i class="icon-material-outline-business-center"></i> Part Time</span></h4>
						  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-feather-mail"></i> demo@example.com</a></span> 
						  <span class="utf-manage-resume-detail-item"><i class="icon-feather-phone"></i> (+12) 0123-654-987</span> 
						  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> 2767 Concord Street</a></span>
                          <div class="utf-buttons-to-right"> 
                  ...
                  <li> 
                    <div class="utf-manage-resume-overview-aera utf-manage-candidate">
                      <div class="utf-manage-resume-overview-aera-inner"> 
                        ...
                        <div class="utf-manage-resume-item">
                          <h4><a href="#">John Williams</a><span class="utf-verified-badge" data-tippy-placement="top" title="Verified Employer" data-tippy=""></span><span class="dashboard-status-button green"><i class="icon-material-outline-business-center"></i> Full Time</span></h4>
                          <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-feather-mail"></i> demo@example.com</a></span> 
						  <span class="utf-manage-resume-detail-item"><i class="icon-feather-phone"></i> (+12) 0123-654-987</span> 
						  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> 2767 Concord Street</a></span>
                          <div class="utf-buttons-to-right"> 
				  ...
				  <li> 
                    <div class="utf-manage-resume-overview-aera utf-manage-candidate">
                      <div class="utf-manage-resume-overview-aera-inner"> 
                        ...
                        <div class="utf-manage-resume-item">
                          <h4><a href="#">John Williams</a><span class="utf-verified-badge" data-tippy-placement="top" title="Verified Employer" data-tippy=""></span><span class="dashboard-status-button yellow"><i class="icon-material-outline-business-center"></i> Part Time</span></h4>
						  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-feather-mail"></i> demo@example.com</a></span> 
						  <span class="utf-manage-resume-detail-item"><i class="icon-feather-phone"></i> (+12) 0123-654-987</span> 
						  <span class="utf-manage-resume-detail-item"><a href="#"><i class="icon-material-outline-location-on"></i> 2767 Concord Street</a></span>
                          <div class="utf-buttons-to-right"> 
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs user-message-box-item"> 
  <div class="utf-signin-form-part">
    <ul class="utf-popup-tabs-nav-item">
		<li class="modal-title">Message to John Williams</li>
	</ul>
    <div class="utf-popup-container-part-tabs"> 
      <div class="utf-popup-tab-content-item" id="tab"> 
        ...
        <button class="button full-width utf-button-sliding-icon ripple-effect" type="submit" form="send-pm">Send Message <i class="icon-feather-chevron-right"></i></button>
      </div>
    </div>
  </div>
</div>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-manage-resume.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:24 GMT -->
</html>