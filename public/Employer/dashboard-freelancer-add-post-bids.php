...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-freelancer-add-post-bids.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:25 GMT -->
<head>
<meta charset="utf-8">
                ...
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="dashboard-manage-tasks.html"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
                      ...
                      <li class="active"><a href="dashboard-freelancer-add-post-bids.html"><i class="icon-feather-chevron-right"></i> Freelancer Post Bids</a></li>
                    </ul>
                  </li>
  ...
  <div class="utf-dashboard-container-aera"> 
    ...
    <div class="utf-dashboard-content-container-aera" data-simplebar>
	  <div id="dashboard-titlebar" class="utf-dashboard-headline-item">
		<div class="row">
			<div class="col-xl-12">	
				<h3>Freelancer Add Manage Post</h3>
				<nav id="breadcrumbs">
					<ul>
					  <li><a href="index-1.html">Home</a></li>
					  <li>Freelancer Add Manage Post</li>
					</ul>
				</nav>
			</div>
		</div>		
      ...
      <div class="utf-dashboard-content-inner-aera"> 
                ...
                <div class="row">
                  <div class="col-xl-6 col-md-6 col-sm-6">
                    <div class="utf-submit-field">
                      <h5>Project Name</h5>
                      <input type="text" class="utf-with-border" placeholder="Project Name">
                    </div>
                  </div>
				  <div class="col-xl-6 col-md-6 col-sm-6">
                    <div class="utf-submit-field">
				  ...
				  <div class="col-xl-6 col-md-6 col-sm-6">
                    <div class="utf-submit-field">
                      <h5>Location</h5>
                      <input type="text" class="utf-with-border" placeholder="Type Address">
                    </div>
                  </div>
				  <div class="col-xl-6 col-md-6 col-sm-6">
                    <div class="utf-submit-field">
				  ...
				  <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="utf-submit-field">
                      <h5>Job Skills? <i class="help-icon" data-tippy-placement="top" title="Maximum of 6 Skills"></i></h5>
                      <div class="keywords-container">
                        <div class="keyword-input-container">
                          <input type="text" class="keyword-input utf-with-border" placeholder="CSS, Photoshop, Js, Bootstrap"/>
				  ...
				  <div class="col-xl-12 col-md-12 col-sm-12">
					 <div class="feedback-yes-no margin-bottom-30 margin-top-10">
						<div class="radio">
						  ...
						  <label for="radio-1"><span class="radio-label"></span> Hourly Price</label>
						</div>
						<div class="radio">
						  <input id="radio-2" name="radio" type="radio">
						  <label for="radio-2"><span class="radio-label"></span> Fixed Price</label>
						</div>
					</div>
				  </div>
				  <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="utf-submit-field">
					  ...
					  <textarea cols="40" rows="2" class="utf-with-border" placeholder="Project Description..."></textarea>                      
                    </div>
                  </div>
				  <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="utf-submit-field">
					  ...
					  <div class="uploadButton margin-top-15 margin-bottom-30">
                        ...
                        <span class="uploadButton-file-name">Upload File (Docx, Doc, PDF) File.</span> 
					  </div>                      
                    </div>
                  </div>                  
                </div>
              ...
              <div class="content with-padding padding-bottom-10">
                <div class="row">
				  ...
				  <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="utf-submit-field">
                      <h5>Description</h5>
					  <textarea cols="20" rows="2" class="utf-with-border" placeholder="Description..."></textarea>                      
                    </div>
                  </div>
                </div>				
              </div>			  
		...
		<div class="utf-centered-button">
			<a href="javascript:void(0);" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-0">Submit <i class="icon-feather-plus"></i></a>			
		</div>
