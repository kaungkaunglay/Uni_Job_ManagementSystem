...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard-freelancer-active-bids.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:25 GMT -->
<head>
<meta charset="utf-8">
                ...
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="dashboard-manage-tasks.html"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
                      ...
                      <li class="active"><a href="dashboard-freelancer-active-bids.html"><i class="icon-feather-chevron-right"></i> Freelancer Active Bids</a></li>
  ...
  <div class="utf-dashboard-container-aera"> 
    ...
    <div class="utf-dashboard-content-container-aera" data-simplebar>
	  <div id="dashboard-titlebar" class="utf-dashboard-headline-item">
		<div class="row">
			<div class="col-xl-12">	
				<h3>Freelancer My Active Bids List</h3>
				<nav id="breadcrumbs">
					<ul>
					  <li><a href="index-1.html">Home</a></li>
					  <li>Freelancer My Active Bids List</li>
					</ul>
				</nav>
			</div>
		</div>		
        ...
        <div class="row"> 
          <div class="col-xl-12">
            <div class="dashboard-box margin-top-0"> 
              <div class="headline">
                <h3>Freelancer Bidder Listing</h3>
              </div>
              <div class="content">
                <ul class="utf-dashboard-box-list">
                  <li> 
                    ...
                    <ul class="dashboard-task-info">
                      <li><strong>$25</strong><span>Hourly Rate</span></li>
                      <li><strong>15 Days</strong><span>Delivery Time</span></li>
                    </ul>
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs"> 
  <div class="utf-signin-form-part">
    <ul class="utf-popup-tabs-nav-item">
		<li class="modal-title">Freelancer Edit Bids</li>
	</ul>
    <div class="utf-popup-container-part-tabs"> 
      <div class="utf-popup-tab-content-item" id="tab"> 
        ...
        <button class="button full-width utf-button-sliding-icon ripple-effect margin-top-20" type="submit">Bidding Save Changes <i class="icon-feather-chevron-right"></i></button>
      </div>
    </div>
  </div>
</div>
