...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/single-freelancers-task-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:00 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Find Jobs</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="#"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
				      ...
				      <li class="active"><a href="single-freelancers-task-page.html"><i class="icon-feather-chevron-right"></i> Freelancer Task Detail</a></li>
        ...
        <div class="utf-right-side">
          ...
          <div class="utf-header-widget-item">
            <div class="utf-header-notifications user-menu">
              <div class="utf-header-notifications-trigger user-profile-title"> <a href="#">
          ...
          <div class="utf-single-page-header-inner-aera">
            <div class="utf-left-side">
              ...
              <div class="utf-header-details">
			    <ul>
                  <li>Afghanistan <img class="flag" src="images/flags/af.svg" alt="" title="Afghanistan" data-tippy-placement="top"></li>                  
                </ul>
                <h3>Ecommerce Laravel Script <span class="utf-verified-badge" title="Verified" data-tippy-placement="top"></span></h3>
				<h4 class="text-muted"><i class="icon-material-outline-business-center"></i> About the Web Developer</h4>
				<h5><i class="icon-material-outline-business"></i> Software Company</h5>
				<div class="utf-star-rating" data-rating="4.9"></div>                
              </div>
            </div>  
			<div class="utf-right-side">
              <div class="salary-box">
				<a href="#small-dialog" class="apply-now-button popup-with-zoom-anim margin-top-0">Apply For Project Budget <i class="icon-feather-chevron-right"></i></a> 
				<a href="#" class="button save-job-btn margin-top-20">Save For Project Budget <i class="icon-feather-chevron-right"></i></a> 				  
			  </div>
            </div>	
          </div>
        </div>
    ...
    <div class="row"> 
      <div class="col-xl-8 col-lg-8 utf-content-right-offset-aera"> 
        ...
        <div class="utf-single-page-section-aera">
          <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-info"></i> About Project Description</h3>
          </div>
          ...
          <ul class="utf-job-deatails-content-item margin-bottom-30">
			...
			<li><i class="icon-feather-arrow-right"></i> Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet.</li>
			<li><i class="icon-feather-arrow-right"></i> Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.</li>
			<li><i class="icon-feather-arrow-right"></i> Donec mollis hendrerit risus. Phasellus nec sem in justo pellentesque facilisis.</li>
			<li><i class="icon-feather-arrow-right"></i> Praesent congue erat at massa. Sed cursus turpis vitae tortor. Donec posuere vulputate arcu.</li>
			<li><i class="icon-feather-arrow-right"></i> Donec elit libero, sodales nec, volutpat a, suscipit non, turpis. Nullam sagittis.</li>
			<li><i class="icon-feather-arrow-right"></i> Pellentesque auctor neque nec urna. Proin sapien ipsum, porta a, auctor quis, euismod ut, mi.</li>
			<li><i class="icon-feather-arrow-right"></i> Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</li>
		  </ul>
		  <div class="row">
			<div class="col-xl-6 col-lg-6 col-sm-12">
				<a href="#small-dialog" class="apply-now-button popup-with-zoom-anim margin-top-0">Apply Project Budget <i class="icon-feather-chevron-right"></i></a>
			</div>
			<div class="col-xl-6 col-lg-6 col-sm-12">
				<a href="#" class="button save-job-btn">Get Project Budget Alerts <i class="icon-feather-chevron-right"></i></a>
			</div>
		  </div>
		  <div class="utf-detail-social-sharing margin-top-40">
			<div class="utf-boxed-list-headline-item">
				<h3><i class="icon-feather-share-2"></i> Social Sharing</h3>
            </div>
        ...
        <div class="utf-single-page-section-aera">
          <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-briefcase"></i> Project Attachments Files</h3>
          </div>
          <div class="attachments-container"> 
			<a href="#" class="attachment-box ripple-effect"><span>Project Brief</span><i>Letter PDF Files</i></a>
			<a href="#" class="attachment-box ripple-effect"><span>Project Document</span><i>Letter PDF Files</i></a>
			<a href="#" class="attachment-box ripple-effect"><span>Project Contact</span><i>Letter DOCX Files</i></a>	
		  </div>
        </div>
        ...
        <div class="utf-single-page-section-aera">
		  <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-briefcase"></i> Project Skills Required</h3>
          </div>
          <div class="task-tags"> 
        ...
        <div class="utf-boxed-list-item margin-bottom-20">
          <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-users"></i> Freelancer Project Bidding</h3>
          </div>
          <ul class="utf-boxed-list-item-ul">
              ...
              <div class="bid"> 
                ...
                <div class="bids-content"> 
                  <div class="utf-manage-resume-item">
                    <h4><a href="single-freelancer-profile.html">John Williams <img class="flag" src="images/flags/af.svg" alt="" title="Afghanistan" data-tippy-placement="top"></a></h4>
                    ...
                    <div class="item-details margin-top-5">
						<div class="utf-detail-item"><i class="icon-material-outline-date-range"></i> 12 Jan, 2021 - 11:00 AM</div>
						<div class="utf-star-rating" data-rating="4.9"></div>
					</div>
                  </div>
                </div>                
                <div class="bids-bid">
                  <div class="bid-rate">
                    <div class="rate">$12,500 Fixed Price</div>
                    <span>in 1 Month to Complete</span> 
				  </div>
                </div>
              </div>
            </li>
            <li>
              <div class="bid"> 
                ...
                <div class="bids-bid">
                  <div class="bid-rate">
                    <div class="rate">$55,00 Hourly Price</div>
                    <span>in 20 Days to Complete</span> 
				  </div>
                </div>
              </div>
            </li>
            <li>
              <div class="bid"> 
                <div class="bids-avatar">
                  <div class="utf-manage-resume-avatar"> <a href="single-freelancer-profile.html"><img src="images/user-avatar-placeholder.png" alt=""></a> </div>
                </div>
                <div class="bids-content"> 
                  <div class="utf-manage-resume-item">
                    <h4><a href="single-freelancer-profile.html">John Williams <img class="flag" src="images/flags/af.svg" alt="" title="Afghanistan" data-tippy-placement="top"></a></h4>
                ...
                <div class="bids-bid">
                  <div class="bid-rate">
                    <div class="rate">$15,00 Hourly Price</div>
                    <span>In 25 Days to Complete</span> 
				  </div>
                </div>
              </div>
            </li>
            <li>
              <div class="bid"> 
                ...
                <div class="bids-bid">
                  <div class="bid-rate">
                    <div class="rate">$48,00 Hourly Price</div>
                    <span>In 25 Days to Complete</span> 
				  </div>
                </div>
              </div>
			...
			<li>
              <div class="bid"> 
                ...
                <div class="bids-bid">
                  <div class="bid-rate">
                    <div class="rate">$42,00 Hourly Price</div>
                    <span>In 25 Days to Complete</span> 
				  </div>
                </div>
              </div>
          ...
          <div class="row">
			  <div class="col-md-12"> 
				<!-- Pagination -->
				<div class="utf-pagination-container-aera margin-top-40 margin-bottom-20">
      ...
      <div class="col-xl-4 col-lg-4">
        <div class="utf-sidebar-container-aera">
          <div class="bidding-countdown margin-bottom-30" title="Project has been verified and belongs business owner or manager." data-tippy-placement="top">12 Days, 5 Hours to Left</div>
		  
		  <div class="utf-sidebar-widget-item">	
			  <h3>Project Budget Price</h3>
			  <div class="utf-right-side">
				<div class="salary-box">
					<div class="salary-amount">$4,500 - $8,200</div>
				</div>
			  </div>
		  </div>
          ...
          <div class="utf-sidebar-widget-item">
            <div class="bidding-widget">
              <div class="utf-bidding-overview-headline">Bidding Information</div>
              <div class="bidding-inner"> 
                <span class="bidding-detail">Bidding Set Your <strong>Hourly Price</strong></span> 
                <div class="bidding-value">$<span id="biddingVal"></span></div>
                <input class="bidding-slider" type="text" value="" data-slider-handle="custom" data-slider-currency="$" data-slider-min="0" data-slider-max="50" data-slider-value="10" data-slider-step="1" data-slider-tooltip="hide" />
                <span class="bidding-detail margin-top-30">Set Your <strong>Project Delivery Time</strong></span> 
                ...
                <button id="snackbar-place-bid" class="button ripple-effect move-on-hover full-width margin-top-25"><span>Apply For Bids</span></button>
              </div>              
            </div>
          </div>
				...
				<div class="row">
				  <div class="col-md-12">
					<div class="utf-no-border">
					  <input class="utf-with-border" name="fristname" type="text" id="fristname" placeholder="Frist Name" required />
					</div>
				  </div>
				  <div class="col-md-12">
					<div class="utf-no-border">
					  <input class="utf-with-border" name="lastname" type="text" id="lastname" placeholder="Last Name" required />
					</div>
				  </div>
				  <div class="col-md-12">
					<div class="utf-no-border">
          ...
          <div class="utf-sidebar-widget-item">
            ...
            <button class="bookmark-button margin-bottom-10"> <span class="bookmark-icon"></span> <span class="bookmark-text">Login to Bookmark Jobs</span> <span class="bookmarked-text">Login to Bookmark Jobs</span> </button>                                   
          </div>
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs"> 
  ...
  <div class="utf-signin-form-part">
    <ul class="utf-popup-tabs-nav-item">
		<li class="modal-title">Apply for Project</li>
	</ul>
    <div class="utf-popup-container-part-tabs"> 
      <div class="utf-popup-tab-content-item" id="tab"> 
        <form method="post">
          <div class="utf-no-border">
            <input type="text" class="utf-with-border" name="name" id="name" placeholder="First Name*" required/>
          </div>
		  <div class="utf-no-border">
            <input type="text" class="utf-with-border" name="name" id="name" placeholder="Last Name*" required/>
          </div>
		  <div class="utf-no-border">
            <input type="text" class="utf-with-border" name="phonenumber" id="phonenumber" placeholder="Phone Number*" required/>
          </div>
		  <div class="utf-no-border">
            <input type="text" class="utf-with-border" name="emailaddress" id="emailaddress" placeholder="Email Address*" required/>
          </div>
		  <div class="utf-no-border">
            <textarea cols="30" rows="2" class="utf-with-border" placeholder="Your Message Sent to The Employer..." required></textarea>
          </div>
          <div class="uploadButton margin-top-25">
            <input class="uploadButton-input" type="file" accept="image/*, application/pdf" id="upload" multiple/>
            <label class="uploadButton-button ripple-effect" for="upload">Attachments File</label>
            <span class="uploadButton-file-name">Upload File Type: zip, pdf, png, jpg</span> 
		  </div>
        </form>
        <button class="button margin-top-35 full-width utf-button-sliding-icon ripple-effect" type="submit">Apply Now <i class="icon-feather-chevron-right"></i></button>
      </div>      
    </div>
  </div>
</div>
<!-- Apply for Project End --> 
