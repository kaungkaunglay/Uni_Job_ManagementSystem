...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/freelancers-bidding-tasks-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:12:58 GMT -->
<head>
<meta charset="utf-8">
...
<div id="wrapper"> 
              ...
              <li><a href="#" class="current">Find Jobs</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="#"><i class="icon-feather-chevron-right"></i> Freelancer Tasks</a>
                    <ul class="dropdown-nav">
                      <li class="active"><a href="freelancers-bidding-tasks-list.html"><i class="icon-feather-chevron-right"></i> Freelancer Bidding Task</a></li>
  ...
  <div id="titlebar" class="gradient">
	<div class="container">
	  <div class="row">
		<div class="col-md-12">
		  <h2>Freelancer Bidding Tasks List</h2>
		  <nav id="breadcrumbs">
			<ul>
			  <li><a href="index-1.html">Home</a></li>
			  <li>Freelancer Bidding Tasks List</li>
			</ul>
		  </nav>
		</div>
	  </div>
    ...
    <div class="row">
      <div class="col-xl-3 col-lg-4">
        <div class="utf-sidebar-container-aera"> 
          ...
          <div class="utf-sidebar-widget-item">
            ...
            <div class="keywords-container">
              <div class="keyword-input-container">
                <input type="text" class="keyword-input" placeholder="Tasks Title Keywords..."/>
          ...
          <div class="utf-sidebar-widget-item">
            ...
            <input class="range-slider" type="text" value="" data-slider-currency="$" data-slider-min="10" data-slider-max="5500" data-slider-step="55" data-slider-value="[10,5500]"/>
          </div>
          
          <div class="utf-sidebar-widget-item">
            <h3>Hourly Rate</h3>
            <div class="margin-top-55"></div>
            <input class="range-slider" type="text" value="" data-slider-currency="$" data-slider-min="10" data-slider-max="250" data-slider-step="15" data-slider-value="[10,250]"/>
          </div>
      ...
      <div class="col-xl-9 col-lg-8 content-left-offset">
		<div class="utf-inner-search-section-title">
			<h4><i class="icon-material-outline-search"></i> Search Listing Results</h4>
		</div>
        <div class="utf-notify-box-aera margin-top-15">
          <div class="utf-switch-container-item">
            <span>Showing 1–10 of 50 Search Results :</span>
          </div> 
		  <div class="sort-by">
			<span>Sort By:</span>
        ...
        <div class="tasks-list-container compact-list margin-top-35"> 
          <a href="single-freelancers-task-page.html" class="task-listing"> 
			  <div class="task-listing-details"> 
				<div class="task-listing-description">
				  <h3 class="task-listing-title">Ecommerce Laravel Script</h3>
				  <ul class="task-icons">
				  ...
				  <p class="task-listing-text">Lorem Ipsum is simply dummy text of printing setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				  <div class="task-tags"> <span>Web Designer</span> <span>Web Developement</span> <span>Android Developer</span> </div>
				</div>
			  </div>
			  <div class="task-listing-bid">
				<div class="task-listing-bid-inner">
				  <div class="task-offers"> <strong><i class="icon-material-outline-account-balance-wallet"></i> $12,000 - $35,500</strong> <span>Fixed Price</span> </div>
				  <span class="button">Apply Bids</span> 
				</div>
			  </div>
          </a> 
          ...
          <a href="single-freelancers-task-page.html" class="task-listing"> 
			  <div class="task-listing-details"> 
				<div class="task-listing-description">
				  <h3 class="task-listing-title">WordPress Theme Developement</h3>
				  <ul class="task-icons">
					<li><i class="icon-material-outline-location-off"></i> Online Job Tasks</li>
					<li><i class="icon-material-outline-access-time"></i> 15 Minute Ago</li>
				  </ul>
				  <p class="task-listing-text">Lorem Ipsum is simply dummy text of printing setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				  <div class="task-tags"> <span>Web Designer</span> <span>Web Developement</span> </div>
				</div>
			  </div>
			  <div class="task-listing-bid">
				<div class="task-listing-bid-inner">
				  <div class="task-offers"> <strong><i class="icon-material-outline-account-balance-wallet"></i> $25 - $60</strong> <span>Hourly Price</span> </div>
				  <span class="button">Apply Bids</span> 
				</div>
			  </div>
          </a>
        ...
        <div class="row">
          <div class="col-md-12"> 
            <!-- Pagination -->
            <div class="utf-pagination-container-aera margin-top-20 margin-bottom-50">
