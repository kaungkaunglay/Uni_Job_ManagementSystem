...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/order-confirmation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:28 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Pages</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="order-confirmation.html"><i class="icon-feather-chevron-right"></i> Order Confirmation</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="utf-order-confirm-aera">
          ...
          <a href="invoice-template.html" class="button margin-top-30">View Invoice</a>
		</div>
      </div>
    </div>
  </div>
