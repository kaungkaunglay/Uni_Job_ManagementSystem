...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/jobs-categorie-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:48 GMT -->
<head>
<meta charset="utf-8">
...
<div id="wrapper"> 
  ...
  <div id="titlebar" class="gradient">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>Categories Style One</h2>
          <nav id="breadcrumbs">
            <ul>
              <li><a href="index-1.html">Home</a></li>
			  <li><a href="#">Pages</a></li>
              <li>Categories Style One</li>
            </ul>
          </nav>
        </div>
      </div>
