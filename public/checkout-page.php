...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/checkout-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:25 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Pages</a>
                <ul class="dropdown-nav">
				  ...
				  <li class="active"><a href="checkout-page.html"><i class="icon-feather-chevron-right"></i> Order Checkout</a></li>
    ...
    <div class="row">
      <div class="col-xl-8 col-lg-8 utf-content-right-offset-aera"> 
        <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-feather-briefcase"></i> Billing Information</h3>
        </div>
		<div class="utf-billing-form-item">
			<form method="post">
				<div class="row">
				  <div class="col-md-6">
					<div class="utf-no-border">
					  <label for="fristname">Frist Name</label>	
					  <input class="utf-with-border" name="name" type="text" id="fristname" placeholder="Frist Name" required />
					</div>
				  </div>
				  <div class="col-md-6">
					<div class="utf-no-border">
				  ...
				  <div class="col-md-6">
					<div class="utf-no-border">
					  ...
					  <input class="utf-with-border" name="phone" type="text" id="phone" placeholder="Phone Number" required />
					</div>
				  </div>
				</div>            
			</form>
		</div>	
		<div class="utf-boxed-list-headline-item margin-top-10">
            <h3><i class="icon-material-outline-description"></i> Select Plan Information</h3>
        </div>
        <div class="utf-plan-pricing-aera"> 
          <div class="radio">
            <input id="radio-5" name="radio-payment-type" type="radio" checked>
            <label for="radio-5"> <span class="radio-label"></span> Monthly Plan <span class="utf-plan-pricing-aera-details"> <span class="regular-price-tag">$89.00 / Par Month</span> </span> </label>
          </div>
          <div class="radio">
            <input id="radio-6" name="radio-payment-type" type="radio">
            <label for="radio-6"><span class="radio-label"></span> Annually Plan <span class="utf-plan-pricing-aera-details"> <span class="discounted-price-tag">$699.00 / Par Year</span> </span> </label>
          </div>
        </div>
        <div class="utf-boxed-list-headline-item margin-top-30">
            <h3><i class="icon-line-awesome-cc-mastercard"></i> Payment Method</h3>
        </div>
        <div class="payment">
		  <div class="payment-tab payment-tab-active">
            <div class="utf-payment-tab-trigger">
              ...
              <img class="payment-logo stripe" src="images/stripe.png" alt=""> 
			</div>
            <div class="utf-payment-tab-content-aera">
              <div class="row payment-form-row">
                <div class="col-md-4">
					<label for="cardNumber">Name</label>
                    <input class="utf-with-border" id="nameOnCard" name="nameOnCard" required type="text" placeholder="Name">					
				</div>
				<div class="col-md-4">
					<label for="cardNumber">Email</label>
                    <input class="utf-with-border" id="cardNumber" name="cardNumber" placeholder="Email" required type="text">					
				</div>
				<div class="col-md-4">
					<label for="cardNumber">Phone Number</label>
                    <input class="utf-with-border" id="expiryDate" placeholder="Phone Number" required type="text">					
				</div>					
              </div>
            </div>
          </div>
          <div class="payment-tab">
            <div class="utf-payment-tab-trigger">
              ...
              <img class="payment-logo paypal" src="images/paypal_pay.png" alt=""> 
			</div>
            <div class="utf-payment-tab-content-aera">
          ...
          <div class="payment-tab">
            <div class="utf-payment-tab-trigger">
              ...
              <img class="payment-logo" src="images/pay_icon.png" alt=""> 
			</div>
            <div class="utf-payment-tab-content-aera">
              <div class="row payment-form-row">
                <div class="col-md-6">
					<label for="cardNumber">Card Number</label>
                    <input class="utf-with-border" id="cardnumber" type="text" placeholder="Card Number" required>					
				</div>
				<div class="col-md-6">
					<label for="cardNumber">Card Holder Name</label>
                    <input class="utf-with-border" id="nameoncard" type="text" placeholder="Card Holder Name" required>					
				</div>
				<div class="col-md-4">
					<label for="cardNumber">Expiry Month</label>
                    <input class="utf-with-border" id="expirydate" type="text" placeholder="Expiry Month" required>					
				</div>
				<div class="col-md-4">
					<label for="expiryDate">Expiry Year</label>
                    <input class="utf-with-border" id="expiryndate" type="text" placeholder="Expiry Year" required>				
				</div>
				<div class="col-md-4">
					<label for="expirydate">CVV Code</label>
                    <input class="utf-with-border" id="cvv" required type="text" placeholder="***">				
				</div>				
              </div>
            </div>
          </div>
        </div>
		<div class="utf-centered-button margin-top-15 margin-bottom-65">
			<a href="order-confirmation.html" class="button big ripple-effect">Confirm Now</a> 
		</div>
	  </div>
      <div class="col-xl-4 col-lg-4 margin-top-0 margin-bottom-60"> 
        <div class="boxed-widget summary margin-top-0">
          ...
          <div class="utf-boxed-widget-inner">
            <ul>
			  <li>Appearing Plan <span>10 Jan 2021</span></li>
			  <li>Disappearing <span>30 Jan 2021</span></li>	
              <li>Standard Plan <span>$159.00</span></li>
              <li>V.A.T (10%) <span>$5.00</span></li>
              <li class="total-costs">Total Cost<span>$164.00</span></li>
            </ul>
          </div>
        </div>        
      </div>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/checkout-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:13:26 GMT -->
</html>