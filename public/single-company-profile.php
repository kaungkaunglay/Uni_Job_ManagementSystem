...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/single-company-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:10:49 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul id="responsive">
              ...
              <li><a href="#" class="current">Find Jobs</a>
                <ul class="dropdown-nav">
                  ...
                  <li class="active"><a href="single-company-profile.html"><i class="icon-feather-chevron-right"></i> Company Profile Detail</a></li>
          ...
          <div class="utf-single-page-header-inner-aera">
            <div class="utf-left-side">
              ...
              <div class="utf-header-details">
                ...
                <h3>Acodia PHP Development Company <span class="utf-verified-badge" title="Verified" data-tippy-placement="top"></span></h3>
				<h4 class="text-muted"><i class="icon-material-outline-business-center"></i> G-Tech Software Company</h4>
    ...
    <div class="row"> 
      <div class="col-xl-8 col-lg-8 utf-content-right-offset-aera">
        ...
        <div class="utf-boxed-list-item margin-bottom-30">
          <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-material-outline-business-center"></i> Open Jobs Position List</h3>
          </div>
        ...
        <div class="utf-boxed-list-item margin-bottom-60">
          <div class="utf-boxed-list-headline-item">
            <h3><i class="icon-material-outline-star-border"></i> Visitor Reviews</h3>
          </div>
				...
				<li>
				  <div class="utf-boxed-list-item-item"> 
					<div class="item-content">
					  ...
					  <a href="#" class="reply"><i class="icon-line-awesome-reply-all"></i> Reply</a>
					  <div class="item-details margin-top-10">
						<div class="utf-detail-item"><i class="icon-material-outline-date-range"></i> 12 Jan, 2021 - 04:00 PM</div>
						<div class="utf-star-rating" data-rating="5.0"></div>
					  </div>
					  <div class="utf-item-description">
          ...
          <div class="utf-centered-button margin-top-35"> <a href="#small-dialog" class="popup-with-zoom-anim button utf-button-sliding-icon">Leave Your Review <i class="icon-feather-chevron-right"></i></a> </div>
        </div>
      </div>
          ...
          <div class="utf-sidebar-widget-item">
			...
			<form method="post" name="contactform" id="contact">
				...
				<div class="utf-centered-button margin-top-10">
					<input type="submit" class="submit button margin-bottom-10" id="submit" value="Submit Message" />
				</div>
			 </form>
		  </div>
    ...
    <div class="utf-popup-container-part-tabs"> 
      <div class="utf-popup-tab-content-item" id="tab"> 
        <form method="post" id="leave-company-review-form">
          ...
          <div class="row">
			<div class="col-xl-6">
              <div class="utf-no-border" title="First Name is Required" data-tippy-placement="top">
                <input type="text" class="utf-with-border" name="firstname" placeholder="First Name*"/>
              </div>
            </div>
            <div class="col-xl-6">
              <div class="utf-no-border" title="Last Name is Required" data-tippy-placement="top">
                <input type="text" class="utf-with-border" name="lastname" placeholder="Last Name*"/>
              </div>
            </div>
            <div class="col-xl-12">
              <div class="utf-no-border">
                <input type="text" class="utf-with-border" name="reviewtitle" id="reviewtitle" placeholder="Review Title" required/>
              </div>
            </div>
          </div>
          <textarea class="utf-with-border" placeholder="Review" name="message" id="message" cols="7" required></textarea>
        </form>
        <button class="button margin-top-35 full-width utf-button-sliding-icon ripple-effect" type="submit" form="leave-company-review-form">Submit Review <i class="icon-feather-chevron-right"></i></button>
      </div>
    </div>
  </div>
</div>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/single-company-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 15:12:58 GMT -->
</html>