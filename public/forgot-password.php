        ...
        <div class="utf-login-register-page-aera margin-bottom-50"> 
          ...
          <form method="post" id="login-form">
            <div class="utf-no-border">
              <input type="text" class="utf-with-border" name="emailaddress" id="emailaddress" placeholder="Enter Your Email" required/>
            </div>            		
          </form>
          <button class="button full-width utf-button-sliding-icon ripple-effect margin-top-10" type="submit" form="login-form">Send Recovery Email <i class="icon-feather-chevron-right"></i></button>          		  
